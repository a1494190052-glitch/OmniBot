...
import cn.com.omnimind.bot.omniflow.model.OmniflowFunction
import cn.com.omnimind.bot.omniflow.model.OmniflowFunctionStore
import cn.com.omnimind.bot.omniflow.model.UIStep
import cn.com.omnimind.bot.omniflow.model.ParameterValue
import cn.com.omnimind.bot.omniflow.model.resolveArgPath
            ...
            val stepResult: Map<String, Any?> = when {
                ...
                executor == RunLogReplayPolicy.EXECUTOR_TOOL && callableTool.isNotEmpty() &&
                    ...
                    runResultBuilder.agentFallbackStep(
                        ...
                        tool = callableTool,
                        prompt = agentPrompt,
                        summary = "Tool step requires VLM continuation: $stepTitle",
                    )
                }
