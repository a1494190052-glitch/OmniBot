package cn.com.omnimind.bot.omniflow.model
...
/**
 * Single-pass compiler from RunLog cards into the typed Function model.
...
object OmniflowCompiler {
    ...
    fun compile(
        ...
        // Phase 3: translate Map steps → UIStep
    ...
    fun applyCheckerRules(fn: OmniflowFunction, rules: List<StepCheckerRule>): OmniflowFunction =
