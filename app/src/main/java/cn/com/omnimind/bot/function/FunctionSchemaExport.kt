...
/**
 * Exportable schema bundle for Function lifecycle/debugging.
 *
    ...
    fun bundle(mcpTools: List<Map<String, Any?>> = emptyList()): Map<String, Any?> =
        linkedMapOf(
            ...
            "schemas" to linkedMapOf(
                ...
                "update_function.input.mcp" to FunctionUpdateToolSchema.inputSchema(
                    includeCamelCaseAliases = false
                ),
                "update_function.input.agent_profile" to FunctionUpdateToolSchema.inputSchema(
                    includeCamelCaseAliases = true
                ),
                "update_function.analysis" to FunctionUpdateToolSchema.analysisSchema,
                "update_function.patch" to FunctionUpdateToolSchema.patchSchema,
            ),
    ...
    private val reusableFunctionSchema: Map<String, Any?>
        get() = obj(
            ...
            properties = linkedMapOf(
                        ...
                        "steps" to array(
                            ...
                            obj(
                                properties = linkedMapOf(
                                    ...
                                    "cleanup_annotation" to FunctionUpdateToolSchema.cleanupAnnotationExportSchema,
                ...
                "agent_reuse" to FunctionUpdateToolSchema.agentReuseExportSchema,
