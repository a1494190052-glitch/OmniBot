...
# - HTML Display may call registered Project APIs through window.oob.callApi.
...
def _build_render_item(
    ...
    if archive_action_id:
        archive_btn = (
            ...
            f"data-oob-api=\"{archive_action_id}\" "
    ...
    for a in agent_actions:
        ...
        fns.append(textwrap.dedent(f"""
            async function {fn_name}(btn) {{
              ...
              const out = result && result.outputs ? result.outputs : {{}};
