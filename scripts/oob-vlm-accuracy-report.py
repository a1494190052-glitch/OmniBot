...
def load_case(name: str, paths: dict[str, Path | None]) -> dict[str, Any]:
    ...
    checks = {
        ...
        "recall_hit_function_id_present": bool(recall_hit_payload.get("function_id")),
    ...
    metrics = {
        ...
        "recall_hit": checks["recall_decision_hit"] and checks["recall_hit_function_id_present"],
    ...
    required = [
        ...
        "recall_success",
        "recall_decision_hit",
        "recall_hit_function_id_present",
