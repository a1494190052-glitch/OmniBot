...
def summarize_result(data: dict[str, Any], output_path: Path, device: str) -> dict[str, Any]:
    ...
    if data.get("parse_only") is True:
        ...
        return {
            ...
            "request_variant": parse_result.get("request_variant"),
            "request_had_tools": parse_result.get("request_had_tools"),
            "request_tool_choice": parse_result.get("request_tool_choice"),
            "request_parallel_tool_calls": parse_result.get("request_parallel_tool_calls"),
