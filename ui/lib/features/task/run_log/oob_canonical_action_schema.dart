...
enum OobActionKind { action, observe, functionInvocation, decision }
...
class OobCanonicalActionSchema {
  ...
  static const tools = <OobActionToolSpec>[
    OobActionToolSpec(
      name: "click",
      kind: OobActionKind.action,
      uiLabel: OobLocalizedText(zhCn: "点击", enUs: "Click"),
      description: OobLocalizedText(zhCn: "点击一个可见目标；x、y 必须提供，target_description 可选。", enUs: "Tap a visible target; x and y are required, while target_description is optional."),
      promptGuide: OobLocalizedText(zhCn: "- click(target_description?, x, y): 点击可见目标；x/y 是 required 的 0..1000 相对坐标，target_description 用于补充 grounding。", enUs: "- click(target_description?, x, y): Tap a visible target; x/y are required 0..1000 relative coordinates, and target_description is an optional grounding hint."),
      argsTemplate: const <String, Object?>{},
      args: <OobActionArgSpec>[
        OobActionArgSpec(name: "target_description", type: OobActionArgType.string, persisted: false, description: OobLocalizedText(zhCn: "可选。要点击的目标描述，用于补充 grounding。", enUs: "Optional. Description of the target to tap, used as a grounding hint.")),
        OobActionArgSpec(name: "node_id", type: OobActionArgType.string, persisted: false, description: OobLocalizedText(zhCn: "可选。live XML 中已确认的无障碍节点 id。", enUs: "Optional. Confirmed accessibility node id from live XML.")),
        OobActionArgSpec(name: "node_resource_id", type: OobActionArgType.string, persisted: false, description: OobLocalizedText(zhCn: "可选。录制或 XML grounding 得到的 Android resource-id，用于重放定位诊断和迁移。", enUs: "Optional. Android resource-id captured from recording or XML grounding, used for replay targeting diagnostics and transfer.")),
        OobActionArgSpec(name: "x", type: OobActionArgType.number, required: true, description: OobLocalizedText(zhCn: "点击位置的 required 0..1000 相对 X 坐标；执行前会解码为屏幕绝对像素。", enUs: "Required 0..1000 relative X coordinate of the tap target; decoded to absolute screen pixels before execution."), minimum: 0, maximum: 1000),
        OobActionArgSpec(name: "y", type: OobActionArgType.number, required: true, description: OobLocalizedText(zhCn: "点击位置的 required 0..1000 相对 Y 坐标；执行前会解码为屏幕绝对像素。", enUs: "Required 0..1000 relative Y coordinate of the tap target; decoded to absolute screen pixels before execution."), minimum: 0, maximum: 1000),
      ],
      modelVisible: true,
      replayable: true,
      editorVisible: true,
    ...
    OobActionToolSpec(
      ...
      promptGuide: OobLocalizedText(zhCn: "- long_press(target_description?, x, y): 长按目标；x/y 是 required 的 0..1000 相对坐标，target_description 用于补充 grounding。", enUs: "- long_press(target_description?, x, y): Long-press a target; x/y are required 0..1000 relative coordinates, and target_description is an optional grounding hint."),
      argsTemplate: const <String, Object?>{},
      args: <OobActionArgSpec>[
        OobActionArgSpec(name: "target_description", type: OobActionArgType.string, persisted: false, description: OobLocalizedText(zhCn: "可选。要长按的目标描述，用于补充 grounding。", enUs: "Optional. Description of the target to long-press, used as a grounding hint.")),
        OobActionArgSpec(name: "node_id", type: OobActionArgType.string, persisted: false, description: OobLocalizedText(zhCn: "可选。live XML 中已确认的无障碍节点 id。", enUs: "Optional. Confirmed accessibility node id from live XML.")),
        OobActionArgSpec(name: "node_resource_id", type: OobActionArgType.string, persisted: false, description: OobLocalizedText(zhCn: "可选。录制或 XML grounding 得到的 Android resource-id，用于重放定位诊断和迁移。", enUs: "Optional. Android resource-id captured from recording or XML grounding, used for replay targeting diagnostics and transfer.")),
        OobActionArgSpec(name: "x", type: OobActionArgType.number, required: true, description: OobLocalizedText(zhCn: "长按位置的 0..1000 相对 X 坐标；执行前会解码为屏幕绝对像素。", enUs: "0..1000 relative X coordinate of the long press; decoded to absolute screen pixels before execution."), minimum: 0, maximum: 1000),
        OobActionArgSpec(name: "y", type: OobActionArgType.number, required: true, description: OobLocalizedText(zhCn: "长按位置的 0..1000 相对 Y 坐标；执行前会解码为屏幕绝对像素。", enUs: "0..1000 relative Y coordinate of the long press; decoded to absolute screen pixels before execution."), minimum: 0, maximum: 1000),
    ...
    OobActionToolSpec(
      ...
      description: OobLocalizedText(zhCn: "向一个可见输入目标输入文本；text、x、y 必须提供，target_description 可选。", enUs: "Type text into a visible input target; text, x, and y are required, while target_description is optional."),
      promptGuide: OobLocalizedText(zhCn: "- input_text(target_description?, text, x, y): 向输入框输入；text、x/y 是 required，target_description 用于补充 grounding。", enUs: "- input_text(target_description?, text, x, y): Type into an input field; text and x/y are required, and target_description is an optional grounding hint."),
      argsTemplate: const <String, Object?>{},
      args: <OobActionArgSpec>[
        OobActionArgSpec(name: "target_description", type: OobActionArgType.string, persisted: false, description: OobLocalizedText(zhCn: "可选。目标输入框描述，用于补充 grounding。", enUs: "Optional. Description of the input target, used as a grounding hint.")),
        ...
        OobActionArgSpec(name: "node_id", type: OobActionArgType.string, persisted: false, description: OobLocalizedText(zhCn: "可选。live XML 中已确认的无障碍节点 id。", enUs: "Optional. Confirmed accessibility node id from live XML.")),
        OobActionArgSpec(name: "node_resource_id", type: OobActionArgType.string, persisted: false, description: OobLocalizedText(zhCn: "可选。录制或 XML grounding 得到的 Android resource-id，用于重放定位诊断和迁移。", enUs: "Optional. Android resource-id captured from recording or XML grounding, used for replay targeting diagnostics and transfer.")),
        OobActionArgSpec(name: "x", type: OobActionArgType.number, required: true, persisted: false, description: OobLocalizedText(zhCn: "目标输入框中心的 required 0..1000 相对 X 坐标；执行前会解码为屏幕绝对像素。", enUs: "Required 0..1000 relative X coordinate of the input target center; decoded to absolute screen pixels before execution."), minimum: 0, maximum: 1000),
        OobActionArgSpec(name: "y", type: OobActionArgType.number, required: true, persisted: false, description: OobLocalizedText(zhCn: "目标输入框中心的 required 0..1000 相对 Y 坐标；执行前会解码为屏幕绝对像素。", enUs: "Required 0..1000 relative Y coordinate of the input target center; decoded to absolute screen pixels before execution."), minimum: 0, maximum: 1000),
      ],
      modelVisible: true,
      replayable: true,
      editorVisible: true,
    ...
    OobActionToolSpec(
      ...
      promptGuide: OobLocalizedText(zhCn: "- swipe(target_description?, direction, x1, y1, x2, y2, duration_ms?): 在屏幕或指定可滚动区域内滑动；direction 和 x1/y1/x2/y2 必须提供，target_description 用于补充 grounding。", enUs: "- swipe(target_description?, direction, x1, y1, x2, y2, duration_ms?): Swipe on the screen or a target scrollable region; direction and x1/y1/x2/y2 are required, and target_description is an optional grounding hint."),
      argsTemplate: const <String, Object?>{},
      args: <OobActionArgSpec>[
        OobActionArgSpec(name: "target_description", type: OobActionArgType.string, persisted: false, description: OobLocalizedText(zhCn: "可选。本次滑动想浏览或定位的目标描述，用于补充 grounding。", enUs: "Optional. Description of what this swipe action is trying to browse or locate, used as a grounding hint.")),
        ...
        OobActionArgSpec(name: "x", type: OobActionArgType.number, persisted: false, description: OobLocalizedText(zhCn: "可选。滑动锚点的 0..1000 相对 X 坐标；不提供时使用安全兜底区域。", enUs: "Optional 0..1000 relative swipe anchor X coordinate; when omitted, the runtime uses a safe fallback region."), minimum: 0, maximum: 1000),
        OobActionArgSpec(name: "y", type: OobActionArgType.number, persisted: false, description: OobLocalizedText(zhCn: "可选。滑动锚点的 0..1000 相对 Y 坐标；不提供时使用安全兜底区域。", enUs: "Optional 0..1000 relative swipe anchor Y coordinate; when omitted, the runtime uses a safe fallback region."), minimum: 0, maximum: 1000),
        OobActionArgSpec(name: "distance", type: OobActionArgType.number, persisted: false, description: OobLocalizedText(zhCn: "可选。滑动距离，使用 0..1000 相对坐标尺度。", enUs: "Optional swipe distance using the 0..1000 relative coordinate scale."), minimum: 0, maximum: 1000),
        OobActionArgSpec(name: "x1", type: OobActionArgType.number, required: true, description: OobLocalizedText(zhCn: "滑动起点的 0..1000 相对 X 坐标；执行前会解码为屏幕绝对像素。", enUs: "Start 0..1000 relative X coordinate; decoded to absolute screen pixels before execution."), minimum: 0, maximum: 1000),
        OobActionArgSpec(name: "y1", type: OobActionArgType.number, required: true, description: OobLocalizedText(zhCn: "滑动起点的 0..1000 相对 Y 坐标；执行前会解码为屏幕绝对像素。", enUs: "Start 0..1000 relative Y coordinate; decoded to absolute screen pixels before execution."), minimum: 0, maximum: 1000),
        OobActionArgSpec(name: "x2", type: OobActionArgType.number, required: true, description: OobLocalizedText(zhCn: "滑动终点的 0..1000 相对 X 坐标；执行前会解码为屏幕绝对像素。", enUs: "End 0..1000 relative X coordinate; decoded to absolute screen pixels before execution."), minimum: 0, maximum: 1000),
        OobActionArgSpec(name: "y2", type: OobActionArgType.number, required: true, description: OobLocalizedText(zhCn: "滑动终点的 0..1000 相对 Y 坐标；执行前会解码为屏幕绝对像素。", enUs: "End 0..1000 relative Y coordinate; decoded to absolute screen pixels before execution."), minimum: 0, maximum: 1000),
    ...
    OobActionToolSpec(
      ...
      promptGuide: OobLocalizedText(zhCn: "- wait(duration_ms): 只在页面明确处于加载、动画或等待外部状态变化时使用。", enUs: "- wait(duration_ms): Use only when the page is clearly loading, animating, or waiting for an external state change."),
      argsTemplate: const <String, Object?>{},
      args: <OobActionArgSpec>[
        OobActionArgSpec(name: "duration_ms", type: OobActionArgType.integer, required: true, description: OobLocalizedText(zhCn: "等待时长，单位毫秒。", enUs: "Wait duration in milliseconds."), minimum: 0),
      ],
      modelVisible: false,
      replayable: true,
      editorVisible: true,
    ...
    OobActionToolSpec(
      name: "call_tool",
      kind: OobActionKind.functionInvocation,
  ...
  static const replayableToolNames = <String>{"click", "long_press", "input_text", "swipe", "open_app", "press_key", "wait"};
  static const actionToolNames = <String>{"click", "long_press", "input_text", "swipe", "open_app", "press_key", "wait"};
