...
class OobCanonicalActionSchema {
  ...
  static const tools = <OobActionToolSpec>[
    OobActionToolSpec(
      ...
      description: OobLocalizedText(zhCn: "点击一个可见目标；必须按 schema 提供 target_description、x、y。", enUs: "Tap a visible target; provide target_description, x, and y as required by the schema."),
      promptGuide: OobLocalizedText(zhCn: "- click(target_description, x, y): 点击可见目标；x/y 是 required 的 0..1000 相对坐标。", enUs: "- click(target_description, x, y): Tap a visible target; x/y are required 0..1000 relative coordinates."),
      argsTemplate: const <String, Object?>{},
      args: <OobActionArgSpec>[
        OobActionArgSpec(name: "target_description", type: OobActionArgType.string, required: true, persisted: false, description: OobLocalizedText(zhCn: "要点击的目标描述。", enUs: "Description of the target to tap.")),
    ...
    OobActionToolSpec(
      ...
      promptGuide: OobLocalizedText(zhCn: "- long_press(target_description, x, y): 长按目标；x/y 是 required 的 0..1000 相对坐标。", enUs: "- long_press(target_description, x, y): Long-press a target; x/y are required 0..1000 relative coordinates."),
      argsTemplate: const <String, Object?>{},
      args: <OobActionArgSpec>[
        OobActionArgSpec(name: "target_description", type: OobActionArgType.string, required: true, persisted: false, description: OobLocalizedText(zhCn: "要长按的目标描述。", enUs: "Description of the target to long-press.")),
        OobActionArgSpec(name: "node_id", type: OobActionArgType.string, persisted: false, description: OobLocalizedText(zhCn: "可选。live XML 中已确认的无障碍节点 id。", enUs: "Optional. Confirmed accessibility node id from live XML.")),
        OobActionArgSpec(name: "node_resource_id", type: OobActionArgType.string, persisted: false, description: OobLocalizedText(zhCn: "可选。录制或 XML grounding 得到的 Android resource-id，用于重放定位诊断和迁移。", enUs: "Optional. Android resource-id captured from recording or XML grounding, used for replay targeting diagnostics and transfer.")),
    ...
    OobActionToolSpec(
      ...
      description: OobLocalizedText(zhCn: "向一个可见输入目标输入文本；必须按 schema 提供 target_description、text、x、y。", enUs: "Type text into a visible input target; provide target_description, text, x, and y as required by the schema."),
      promptGuide: OobLocalizedText(zhCn: "- input_text(target_description, text, x, y): 向输入框输入；x/y 是 required 的 0..1000 相对坐标。", enUs: "- input_text(target_description, text, x, y): Type into an input field; x/y are required 0..1000 relative coordinates."),
      argsTemplate: const <String, Object?>{},
      args: <OobActionArgSpec>[
        OobActionArgSpec(name: "target_description", type: OobActionArgType.string, required: true, persisted: false, description: OobLocalizedText(zhCn: "要输入文本的目标输入框描述。", enUs: "Description of the input target.")),
    ...
    OobActionToolSpec(
      ...
      promptGuide: OobLocalizedText(zhCn: "- swipe(target_description, direction, x1, y1, x2, y2, duration_ms?): 在屏幕或指定可滚动区域内滑动；direction 和 x1/y1/x2/y2 必须满足 schema.required。", enUs: "- swipe(target_description, direction, x1, y1, x2, y2, duration_ms?): Swipe on the screen or a target scrollable region; direction and x1/y1/x2/y2 must satisfy schema.required."),
      argsTemplate: const <String, Object?>{},
      args: <OobActionArgSpec>[
        OobActionArgSpec(name: "target_description", type: OobActionArgType.string, required: true, persisted: false, description: OobLocalizedText(zhCn: "本次滑动想浏览或定位的目标描述。", enUs: "Description of what this swipe action is trying to browse or locate.")),
