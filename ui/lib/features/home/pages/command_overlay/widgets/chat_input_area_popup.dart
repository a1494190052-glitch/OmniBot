  ...
  Widget buildPopupMenu() {
    ...
    final actions = <_TrajectoryPopupAction>[
      _TrajectoryPopupAction(
        ...
        label: 'RunLog',
        onTap: ManualRecordingFlowController.openRunLogList,
      ),
      _TrajectoryPopupAction(
        icon: Icons.trip_origin_rounded,
        label: locale.languageCode == 'en' ? 'Previous' : '上一个',
        onTap: () => ManualRecordingFlowController.openPreviousRunLog(
          context,
          isMounted: () => mounted,
        ),
      ),
      _TrajectoryPopupAction(
        ...
        label: locale.languageCode == 'en' ? 'Record' : '录制',
        onTap: () => ManualRecordingFlowController.startStandalone(
          context: context,
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: Icon(action.icon, size: 20, color: accentColor),
            ),
