...
class _AccessibilityPermissionDialogState
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      title: Text(_text('开启无障碍以继续', 'Enable accessibility to continue')),
      content: Column(
      ...
      actions: [
        ...
        FilledButton(
          ...
          child: Text(_text('打开无障碍', 'Open accessibility')),
        ),
      ],
    );
  }
...
String _text(String zh, String en) => AppTextLocalizer.choose(zh: zh, en: en);
