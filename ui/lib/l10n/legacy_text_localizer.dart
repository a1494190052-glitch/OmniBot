...
class LegacyTextLocalizer {
  ...
  static final Map<String, String> _exactEn = <String, String>{
    ...
    '使用官方托管 VLM 服务': 'Use Official Hosted VLM Service',
    '官方托管 VLM 服务': 'Official Hosted VLM Service',
    '官方托管 VLM 服务已启用': 'Official hosted VLM service enabled',
    '自定义模型已启用': 'Custom model enabled',
    '已启用内置模型服务': 'Built-in model service enabled',
    '已启用官方托管 VLM 服务': 'Official hosted VLM service enabled',
