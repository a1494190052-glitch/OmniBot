...
ArgSpec(
                    ...
                    type = Type.NUMBER,
                    required = true,
                    description = LocalizedText(zhCn = "兜底点击位置的 X 坐标。", enUs = "Fallback X coordinate of the tap target."),
                    minimum = 0,
                    maximum = 1000,
                ),
ArgSpec(
                    ...
                    type = Type.NUMBER,
                    required = true,
                    description = LocalizedText(zhCn = "兜底点击位置的 Y 坐标。", enUs = "Fallback Y coordinate of the tap target."),
                    minimum = 0,
                    maximum = 1000,
                ),
            ),
...
ArgSpec(
                    ...
                    type = Type.NUMBER,
                    required = true,
                    description = LocalizedText(zhCn = "长按位置的 X 坐标。", enUs = "X coordinate of the long press."),
                    minimum = 0,
                    maximum = 1000,
                ),
ArgSpec(
                    ...
                    type = Type.NUMBER,
                    required = true,
                    description = LocalizedText(zhCn = "长按位置的 Y 坐标。", enUs = "Y coordinate of the long press."),
                    minimum = 0,
                    maximum = 1000,
                ),
ArgSpec(
...
ArgSpec(
                    ...
                    type = Type.NUMBER,
                    required = true,
                    description = LocalizedText(zhCn = "兜底目标输入框中心的 X 坐标。", enUs = "Fallback X coordinate of the input target center."),
                    minimum = 0,
                    maximum = 1000,
                ),
ArgSpec(
                    ...
                    type = Type.NUMBER,
                    required = true,
                    description = LocalizedText(zhCn = "兜底目标输入框中心的 Y 坐标。", enUs = "Fallback Y coordinate of the input target center."),
                    minimum = 0,
                    maximum = 1000,
                ),
            ),
...
ArgSpec(
                    ...
                    type = Type.NUMBER,
                    required = true,
                    description = LocalizedText(zhCn = "起点 X 坐标。", enUs = "Start X coordinate."),
                    minimum = 0,
                    maximum = 1000,
                ),
ArgSpec(
                    ...
                    type = Type.NUMBER,
                    required = true,
                    description = LocalizedText(zhCn = "起点 Y 坐标。", enUs = "Start Y coordinate."),
                    minimum = 0,
                    maximum = 1000,
                ),
ArgSpec(
                    ...
                    type = Type.NUMBER,
                    required = true,
                    description = LocalizedText(zhCn = "终点 X 坐标。", enUs = "End X coordinate."),
                    minimum = 0,
                    maximum = 1000,
                ),
ArgSpec(
                    ...
                    type = Type.NUMBER,
                    required = true,
                    description = LocalizedText(zhCn = "终点 Y 坐标。", enUs = "End Y coordinate."),
                    minimum = 0,
                    maximum = 1000,
                ),
ArgSpec(
