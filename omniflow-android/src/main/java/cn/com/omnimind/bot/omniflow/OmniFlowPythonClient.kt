...
class OmniFlowPythonClient(
    ...
    companion object {
        ...
        fun bridgeCommand(shellSitePackagesPath: String): String {
        ...
        fun defaultTimeoutMs(operation: String): Long = when (operation) {
            "function_tool" -> SEMANTIC_COMPILE_TIMEOUT_MS
            "run" -> RUN_TIMEOUT_MS
